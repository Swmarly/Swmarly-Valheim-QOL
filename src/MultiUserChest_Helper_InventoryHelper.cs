...
namespace SwmarlyValheimQOL {
    public static class InventoryHelper {
        ...
        public static ItemDrop.ItemData ClampStackSize(this ItemDrop.ItemData item) {
            ...
            ItemDrop itemPrefab = ObjectDB.instance == null ? null : ObjectDB.instance.GetItemPrefab(item.PrefabName())?.GetComponent<ItemDrop>();
            if (itemPrefab != null) item.m_shared.m_maxStackSize = itemPrefab.m_itemData.m_shared.m_maxStackSize;
            return item;
        }
